...
class PicturesActivity : AppCompatActivity() {
    ...
    private fun getPictures() {
        lifecycleScope.launch {
            ApiClient.apiService.getPictures(key).onSuccess {
                val picturesList = it
                if (picturesList?.isNotEmpty() == true) {
    ...
    private fun addToList(page: Int?) {
        lifecycleScope.launch {
            ...
            ApiClient.apiService.getPictures(key, page).onSuccess {
                val picturesList = it
    ...
    private fun setRecyclerView() {
        ...
        adapter.setItemListener(object : RecyclerClickListener {
            ...
            override fun onItemClick(view: View, position: Int) {
                val intent = Intent(this@PicturesActivity, ShowPictureActivity::class.java)
